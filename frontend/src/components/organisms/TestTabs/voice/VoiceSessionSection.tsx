          ...
          <>
            <div className={styles.formGrid}>
              ...
              <TextInput
                id="twilio-transport"
                labelText="当前接入方式"
                value="Twilio Media Streams -> Gemini Live 音频双向桥接"
                readOnly
                helperText="Twilio 只负责电话接入与音频转发，Gemini Live 负责实时听说与回合控制。"
              />
              ...
              <TextInput
                ...
                readOnly
                helperText="真实手机直接拨打这个号码，也会走同一条 Twilio Media Streams 电话链路。"
              />
            </div>
            <p className={styles.description}>
